...
- Terraform (v1.6.0+): Installed locally for the initial bootstrap or local testing.

- AWS CLI: Installed and authenticated (only required for bootstrap).

- Pre-commit: Installed to for local testing
...
- Static Analysis: Runs Checkov to ensure your Terraform code
meets strict AWS security best practices prior to deployment.

- Automated Apply: Provisions all core infrastructure resources.
